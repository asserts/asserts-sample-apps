...
[IMPORTANT]
Ensure you have xref:ROOT:prereqs.adoc[prerequisites] installed and available on your $PATH environment variable before attempting to run this sample app locally
